...
public class addRole {
	...
	public void addRole(user rs) throws SQLException{
		...
		//增加一个用户、删除一个用户、修改用户信息、查询用户登录情况、更新个人情况。
			...
			Label la1=new Label("身份:");
			Label la2=new Label("昵称:");
			Label la3=new Label("简介:");
			Label la4=new Label("权限:");
				...
				public void actionPerformed(ActionEvent e){
					...
					try {
						...
						f.setVisible(false);
							...
							JOptionPane.showMessageDialog(null,"角色已经存在！");

...
public class ez1 {
	private String name;
	public void ez1(user rs) throws SQLException{
		String aaaa=rs.getIdentity();
		 this.name=rs.getUsername();
		 Frame f=new Frame("人事管理");
		...
		//
			Button btn1=new Button("查询人事记录");
			Button btn2=new Button("统计人事记录");
			Button btn3=new Button("修改人事记录");

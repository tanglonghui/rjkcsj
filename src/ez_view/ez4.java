...
public class ez4 {
	private String name;
	public void ez4(user rs) throws SQLException{
		...
		//
			Button btn1=new Button("查询技术记录");
			Button btn2=new Button("统计技术记录");
			Button btn3=new Button("修改技术记录");

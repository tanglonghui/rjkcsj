...
public class ez3 {
	private String name;
	public void ez3(user rs) throws SQLException{
		String aaaa=rs.getIdentity();
		 this.name=rs.getUsername();
		 Frame f=new Frame("销售管理");
		...
		//
			Button btn1=new Button("查询销售记录");
			Button btn2=new Button("统计销售记录");
			Button btn3=new Button("修改销售记录");
